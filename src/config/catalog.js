...
window.CATALOG = {
  SKINS: {
    ...
    disco: { name: 'DISCO KING', price: 2000, dir: 'disco', hit: true, cap: 'cap-disco' },
    cowboy: { name: 'COWBOY TRUMP', price: 2000, dir: 'cowboy', hit: true, cap: 'cap-cowboy' },
    santa: { name: 'SANTA TRUMP', price: 2500, dir: 'santa', hit: true, cap: 'cap-santa' },
    mummy: { name: 'MUMMY TRUMP', price: 2500, dir: 'mummy', hit: true, cap: 'cap-mummy' },
    vampire: { name: 'VAMPIRE TRUMP', price: 2500, dir: 'vampire', hit: true, cap: 'cap-vampire' },
    sumo: { name: 'SUMO TRUMP', price: 3000, dir: 'sumo', hit: true, cap: 'cap-sumo' },
    zombie: { name: 'ZOMBIE TRUMP', price: 3000, dir: 'zombie', hit: true, cap: 'cap-zombie' },
    Catwoman: { name: 'CATWOMAN', price: 3000, dir: 'catwoman', hit: true, cap: 'cap-catwoman' },
    ...
    lihi: { name: 'LIHI', price: 0, dir: 'lihi', hit: true, secret: true, code: '555555', cap: 'cap-lihi' },
